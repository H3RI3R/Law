    ...
    <section id="about" className="py-20 px-4 max-w-7xl mx-auto border-t border-[#9C7A58]/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
        <div>
          ...
          <div className="bg-white border-l-4 border-[#9C7A58] p-6 shadow-xs">
            <h4 className="font-serif text-lg text-[#9C7A58] font-bold mb-2">
              Our Practice Philosophy
            </h4>
            <p className="text-xs md:text-sm text-[#3A3A3A] italic leading-relaxed">
        ...
        <div id="why-us" className="bg-white border border-[#9C7A58]/20 p-8 rounded-sm shadow-xs">
          <h3 className="font-serif text-2xl text-[#9C7A58] font-bold mb-6">
            WHY APRAJITA LEGAL?
          </h3>
          <ul className="space-y-4 text-xs md:text-sm text-[#3A3A3A]">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[#6B6B6B] text-xs mt-0.5">Specialized mastery across GST, Customs, Income Tax &amp; Economic Offences.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-[#B58B66]/20 text-[#9C7A58] flex items-center justify-center font-bold text-xs shrink-0">
              ...
              <div>
                ...
                <p className="text-[#6B6B6B] text-xs mt-0.5">Seamlessly blending advisory, regulatory compliance, and trial strategy.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-[#B58B66]/20 text-[#9C7A58] flex items-center justify-center font-bold text-xs shrink-0">
              ...
              <div>
                ...
                <p className="text-[#6B6B6B] text-xs mt-0.5">Backed by meticulous drafting and strong advocacy before Supreme Court &amp; High Courts.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-[#B58B66]/20 text-[#9C7A58] flex items-center justify-center font-bold text-xs shrink-0">
              ...
              <div>
                ...
                <p className="text-[#6B6B6B] text-xs mt-0.5">Proven track record in high-stakes commercial litigation and investigation defense.</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div id="sectors" className="pt-10 border-t border-[#9C7A58]/20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {sectors.map((sector, index) => (
            <div
              key={index}
              className="bg-white border border-[#9C7A58]/20 p-4 text-center rounded-sm hover:border-[#9C7A58] transition-colors"
            >
              <div className="w-2 h-2 rounded-full bg-[#B58B66] mx-auto mb-2"></div>
              <span className="text-xs font-semibold text-[#3A3A3A] tracking-tight">
                {sector}
              </span>
            </div>
          ))}
