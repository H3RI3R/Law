...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <main id="hero-section" className="pt-32 pb-20 px-4 max-w-7xl mx-auto relative z-10 flex flex-col items-center">
      {/* Headline & Subtext */}
      <div className="text-center max-w-4xl mx-auto mb-12 mt-10">
        ...
        <p className="dark-copy text-[#6B6B6B] text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="mt-8">
          <button
            ...
            className="inline-flex items-center gap-2 bg-[#B58B66] hover:bg-[#9C7A58] text-white px-8 py-3.5 rounded-xl text-sm font-medium transition-colors cursor-pointer"
          >
      ...
      <div className="relative w-full max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between mb-24 min-h-[500px]">
        ...
        {/* Left Text */}
        <div className="md:w-1/4 text-sm dark-copy text-[#6B6B6B] text-left relative z-10 pl-4 md:pl-0 mt-8 md:mt-0 order-2 md:order-1">
      ...
      <div className="max-w-4xl mx-auto text-center mb-24 px-4">
        <h2 className="font-sans text-3xl md:text-4xl dark-copy text-[#6B6B6B] font-light leading-relaxed">
